...
export default class pixelit {
    ...
    */
     ...
     */
    pixelate() {
      this.drawto.width = (this.drawfrom.naturalWidth * 2);
      this.drawto.height = (this.drawfrom.naturalHeight* 2);
      ...
      let finalWidth = (this.drawfrom.naturalWidth * 2);
      if ((this.drawfrom.naturalWidth * 2) > 300) {
        finalWidth +=
          (this.drawfrom.naturalWidth * 2) > (this.drawfrom.naturalHeight* 2)
            ? parseInt(
                (this.drawfrom.naturalWidth * 2) / ((this.drawfrom.naturalWidth * 2) * this.scale)
              ) / 1.5
            : parseInt(
                (this.drawfrom.naturalWidth * 2) / ((this.drawfrom.naturalWidth * 2) * this.scale)
              );
      }
      let finalHeight = (this.drawfrom.naturalHeight* 2);
      if ((this.drawfrom.naturalHeight* 2) > 300) {
        finalHeight +=
          (this.drawfrom.naturalHeight* 2) > (this.drawfrom.naturalWidth * 2)
            ? parseInt(
                (this.drawfrom.naturalHeight* 2) / ((this.drawfrom.naturalHeight* 2) * this.scale)
              ) / 1.5
            : parseInt(
                (this.drawfrom.naturalHeight* 2) / ((this.drawfrom.naturalHeight* 2) * this.scale)
              );
